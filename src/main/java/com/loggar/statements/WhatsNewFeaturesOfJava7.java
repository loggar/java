...
public class WhatsNewFeaturesOfJava7 {
	...
	/*
	 * now we can use single catch statement for throwing multiple exception by
	 * using "|" operator.
	 * 
	 */
	@Test
	...
	/*
	 * no need to close() resource because Java7 provides the try-with-resources
	 * statement.
	 */
	@Test
	public void noNeedCloseResource() {
		String s = "./dist/io/test.txt";
