		...
		for (Method m : testClass.getDeclaredMethods()) {
			if (m.isAnnotationPresent(_02_ExceptionTest.class)) {
				...
				try {
					...
					Class<? extends Exception> excType = m.getAnnotation(_02_ExceptionTest.class).value();
